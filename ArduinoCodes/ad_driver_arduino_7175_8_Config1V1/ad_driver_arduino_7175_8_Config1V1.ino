...
ad717x_st_reg ad7175_8_regs[] = {
  ...
  {
    AD717X_FILTCON0_REG,
    0x0507, //AD717X_FILT_CONF_REG_ENHFILT(2) | AD717X_FILT_CONF_REG_ODR(10),
    2
  },
  {
    AD717X_FILTCON1_REG,
...
//  }*/
  ...
  //while (1) {
  //  buf[0] = 0x47; buf[1] = 0x00; buf[2] = 0x00; buf[3] = 0x00;
  //  spi_write_and_read(0, (uint8_t *)(&buf), 3);
  //}
  pinMode(2, INPUT);
  pinMode(3, OUTPUT);
...
void loop() {
    ...
    /* WaitforReady-Check! Something went wrong, check the value of ret: */
    ...
    Serial.println(String(sample*5000.0/256/256/256,6)); //inital Serial.println(sample);
}
